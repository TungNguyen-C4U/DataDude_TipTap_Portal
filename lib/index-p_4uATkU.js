...
var A = (e, o, n) => o in e ? S(e, o, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[o] = n;
var y = (e, o, n) => A(e, typeof o != "symbol" ? o + "" : o, n);
import { useSyncExternalStore as D, useMemo as L, useEffect as E } from "react";
const w = "en", B = 200, it = B - 80, lt = 20, rt = 1e5, dt = 16, at = 10, nt = 10, st = 2, pt = [
  "#000000",
  "#262626",
  "#595959",
  "#8C8C8C",
...
var R = /* @__PURE__ */ ((e) => (e[e["size-small"] = 200] = "size-small", e[e["size-medium"] = 500] = "size-medium", e["size-large"] = "100%", e))(R || {});
const mt = ["100%", "115%", "150%", "200%", "250%", "300%"], ct = "1", ht = [
  "bold",
  "italic",
  "underline",
  "strike",
...
function I({
  ...
  return {
    ...
    propagate(t) {
      let i = 32, l = t, d = 0;
      t: do {
        const r = t.sub, a = r.flags;
        if (!(a & 244) && (r.flags = a | i | 8, !0) || a & 16 && !(a & 4) && (r.flags = a & -17 | i | 8, !0) || !(a & 224) && f(t, r) && (r.flags = a | 16 | i | 8, r.subs !== void 0)) {
          const g = r.subs;
          if (g !== void 0) {
            g.nextSub !== void 0 ? (g.prevSub = l, t = l = g, i = 64, ++d) : (t = g, i = a & 2 ? 128 : 64);
            continue;
          }
          a & 2 && (s !== void 0 ? s.depsTail.nextDep = r.deps : n = r, s = r);
        } else a & (4 | i) ? !(a & i) && a & 224 && f(t, r) && (r.flags = a | i) : (r.flags = a | i | 8, (a & 10) === 2 && (s !== void 0 ? s.depsTail.nextDep = r.deps : n = r, s = r));
        if ((t = l.nextSub) !== void 0) {
          l = t, i = d ? 64 : 32;
          continue;
        }
        for (; d; ) {
          --d;
          const x = l.dep.subs;
          if (l = x.prevSub, x.prevSub = void 0, (t = l.nextSub) !== void 0) {
            l = t, i = d ? 64 : 32;
            continue t;
          }
        }
     ...
     */
    startTracking(t) {
      t.depsTail = void 0, t.flags = t.flags & -249 | 4;
    },
    /**
    ...
    endTracking(t) {
      ...
      } else t.deps !== void 0 && (b(t.deps), t.deps = void 0);
      t.flags &= -5;
    },
    /**
     ...
     */
    updateDirtyFlag(t, i) {
      return h(t.deps) ? (t.flags = i | 32, !0) : (t.flags = i & -65, !1);
    },
    /**
     ...
     * @param flags - The current flag set for this subscriber.
     */
    processComputedUpdate(t, i) {
      if ((i & 32 || (h(t.deps) || (t.flags = i & -65, !1))) && e(t)) {
        const l = t.subs;
        l !== void 0 && m(l);
      }
    },
     ...
     */
    processPendingInnerEffects(t, i) {
      if (i & 128) {
        t.flags = i & -129;
        let l = t.deps;
        do {
    ...
    processEffectNotifications() {
      for (; n !== void 0; ) {
        const t = n, i = t.depsTail, l = i.nextDep;
        l !== void 0 ? (i.nextDep = void 0, n = l.sub) : (n = void 0, s = void 0), o(t) || (t.flags &= -9);
      }
    }
  };
  function p(t, i, l, d) {
    ...
    if (d === void 0 ? i.deps = r : d.nextDep = r, t.subs === void 0)
      t.subs = r;
    else {
      const a = t.subsTail;
      r.prevSub = a, a.nextSub = r;
    }
    return i.depsTail = r, t.subsTail = r, r;
  }
  function h(t) {
    let i = 0, l;
    t: do {
      ...
      if ("flags" in d) {
        ...
        if ((r & 33) === 33) {
          ...
          const a = d.subs;
          a.nextSub !== void 0 && (a.prevSub = t), t = d.deps, ++i;
          continue;
        }
      }
      if (!l && t.nextDep !== void 0) {
        t = t.nextDep;
        continue;
      }
      if (i) {
        ...
        do {
          ...
          if (l) {
            if (e(r)) {
              (t = a.prevSub) !== void 0 ? (a.prevSub = void 0, m(r.subs), r = t.sub) : r = a.sub;
              continue;
            }
          } else
            r.flags &= -65;
          if ((t = a.prevSub) !== void 0) {
            if (a.prevSub = void 0, t.nextDep !== void 0) {
              t = t.nextDep;
              continue t;
            }
            r = t.sub;
          } else {
            if ((t = a.nextDep) !== void 0)
              continue t;
            r = a.sub;
          }
          l = !1;
  ...
  function m(t) {
    do {
      const i = t.sub, l = i.flags;
      (l & 96) === 64 && (i.flags = l | 32 | 8, (l & 10) === 2 && (s !== void 0 ? s.depsTail.nextDep = i.deps : n = i, s = i)), t = t.nextSub;
    } while (t !== void 0);
  }
  function f(t, i) {
    const l = i.depsTail;
  ...
  function b(t) {
    do {
      const i = t.dep, l = t.nextDep, d = t.nextSub, r = t.prevSub;
      if (d !== void 0 ? d.prevSub = r : i.subsTail = r, r !== void 0 ? r.nextSub = d : i.subs = d, i.subs === void 0 && "deps" in i) {
        const a = i.flags;
        a & 32 || (i.flags = a | 32);
        const g = i.deps;
        if (g !== void 0) {
          t = g, i.depsTail.nextDep = l, i.deps = void 0, i.depsTail = void 0;
          continue;
        }
      }
      t = l;
...
var {
  ...
  updateComputed(e) {
    ...
    u = e, v(e);
    try {
      const n = e.currentValue, s = e.getter(n);
      return n !== s ? (e.currentValue = s, !0) : !1;
    } finally {
      u = o, T(e);
    }
  },
  notifyEffect(e) {
    return "isScope" in e ? K(e) : M(e);
  }
}), u;
function P(e) {
  return V.bind({
...
function j(e) {
  ...
  return u !== void 0 && F(o, u), C(o), O.bind(o);
}
function C(e) {
  const o = u;
  u = e, v(e);
...
function M(e) {
  const o = e.flags;
  return o & 32 || o & 64 && N(e, o) ? C(e) : _(e, e.flags), !0;
}
function K(e) {
  return e.flags & 128 ? (_(e, e.flags), !0) : !1;
}
function V(...e) {
  if (e.length) {
    if (this.currentValue !== (this.currentValue = e[0])) {
      const o = this.subs;
      o !== void 0 && (W(o), U());
    }
  } else
    return u !== void 0 && F(this, u), this.currentValue;
}
function O() {
  v(this), T(this);
}
...
const k = new tt(), z = q(c.lang);
function bt() {
  const [e, o] = H(z), n = L(() => k.buildLocalesHandler(e), [e]);
  return E(() => {
...
const kt = {
  t: (e, o) => k.buildLocalesHandler(z())(e, o)
};
export {
  ht as B,
  pt as C,
