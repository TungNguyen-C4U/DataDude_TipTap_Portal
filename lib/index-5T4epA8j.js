...
var S = (e, o, n) => o in e ? A(e, o, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[o] = n;
var F = (e, o, n) => S(e, typeof o != "symbol" ? o + "" : o, n);
import { useSyncExternalStore as y, useMemo as E, useEffect as L } from "react";
const w = "en", B = 200, ot = B - 80, it = 20, rt = 1e5, lt = 16, dt = 10, at = 10, nt = 2, st = [
  "#000000",
  "#262626",
  "#595959",
  "#8C8C8C",
...
var I = /* @__PURE__ */ ((e) => (e[e["size-small"] = 200] = "size-small", e[e["size-medium"] = 500] = "size-medium", e["size-large"] = "100%", e))(I || {});
const gt = ["100%", "115%", "150%", "200%", "250%", "300%"], mt = "1", ct = [
  "bold",
  "italic",
  "underline",
  "strike",
...
function R({
  ...
  return {
    ...
    propagate(t) {
      let i = 32, r = t, d = 0;
      t: do {
        const l = t.sub, a = l.flags;
        if (!(a & 244) && (l.flags = a | i | 8, !0) || a & 16 && !(a & 4) && (l.flags = a & -17 | i | 8, !0) || !(a & 224) && h(t, l) && (l.flags = a | 16 | i | 8, l.subs !== void 0)) {
          const g = l.subs;
          if (g !== void 0) {
            g.nextSub !== void 0 ? (g.prevSub = r, t = r = g, i = 64, ++d) : (t = g, i = a & 2 ? 128 : 64);
            continue;
          }
          a & 2 && (s !== void 0 ? s.depsTail.nextDep = l.deps : n = l, s = l);
        } else a & (4 | i) ? !(a & i) && a & 224 && h(t, l) && (l.flags = a | i) : (l.flags = a | i | 8, (a & 10) === 2 && (s !== void 0 ? s.depsTail.nextDep = l.deps : n = l, s = l));
        if ((t = r.nextSub) !== void 0) {
          r = t, i = d ? 64 : 32;
          continue;
        }
        for (; d; ) {
          --d;
          const T = r.dep.subs;
          if (r = T.prevSub, T.prevSub = void 0, (t = r.nextSub) !== void 0) {
            r = t, i = d ? 64 : 32;
            continue t;
          }
        }
    ...
    endTracking(t) {
      ...
      if (i !== void 0) {
        const r = i.nextDep;
        r !== void 0 && (x(r), i.nextDep = void 0);
      } else t.deps !== void 0 && (x(t.deps), t.deps = void 0);
      t.flags &= -5;
    },
    /**
     ...
     */
    updateDirtyFlag(t, i) {
      return v(t.deps) ? (t.flags = i | 32, !0) : (t.flags = i & -65, !1);
    },
    /**
    ...
    processComputedUpdate(t, i) {
      if ((i & 32 || (v(t.deps) || (t.flags = i & -65, !1))) && e(t)) {
        const r = t.subs;
        r !== void 0 && c(r);
      }
    },
    ...
    processEffectNotifications() {
      for (; n !== void 0; ) {
        const t = n, i = t.depsTail, r = i.nextDep;
        r !== void 0 ? (i.nextDep = void 0, n = r.sub) : (n = void 0, s = void 0), o(t) || (t.flags &= -9);
      }
    }
  };
  function p(t, i, r, d) {
    ...
    if (d === void 0 ? i.deps = l : d.nextDep = l, t.subs === void 0)
      t.subs = l;
    else {
      const a = t.subsTail;
      l.prevSub = a, a.nextSub = l;
    }
    return i.depsTail = l, t.subsTail = l, l;
  }
  function v(t) {
    let i = 0, r;
    t: do {
      ...
      if (i) {
        ...
        do {
          ...
          if (r) {
            if (e(l)) {
              (t = a.prevSub) !== void 0 ? (a.prevSub = void 0, c(l.subs), l = t.sub) : l = a.sub;
              continue;
            }
          } else
            l.flags &= -65;
  ...
  function c(t) {
    do {
      const i = t.sub, r = i.flags;
      (r & 96) === 64 && (i.flags = r | 32 | 8, (r & 10) === 2 && (s !== void 0 ? s.depsTail.nextDep = i.deps : n = i, s = i)), t = t.nextSub;
    } while (t !== void 0);
  }
  function h(t, i) {
    const r = i.depsTail;
  ...
  function x(t) {
    do {
      const i = t.dep, r = t.nextDep, d = t.nextSub, l = t.prevSub;
      if (d !== void 0 ? d.prevSub = l : i.subsTail = l, l !== void 0 ? l.nextSub = d : i.subs = d, i.subs === void 0 && "deps" in i) {
        const a = i.flags;
        a & 32 || (i.flags = a | 32);
        const g = i.deps;
        if (g !== void 0) {
          t = g, i.depsTail.nextDep = r, i.deps = void 0, i.depsTail = void 0;
          continue;
        }
      }
      t = r;
...
function j(e) {
  ...
  return u !== void 0 && C(o, u), z(o), V.bind(o);
}
function z(e) {
  const o = u;
  u = e, b(e);
...
function M(e) {
  const o = e.flags;
  return o & 32 || o & 64 && P(e, o) ? z(e) : _(e, e.flags), !0;
}
function q(e) {
...
const f = new Q(), D = O(m.lang);
function ft() {
  const [e, o] = K(D), n = E(() => f.buildLocalesHandler(e), [e]);
  return L(() => {
