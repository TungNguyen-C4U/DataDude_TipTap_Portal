...
import { T as S, a as z, Q as N, i as U, b as Z, g as $ } from "./RichTextEditor-D4neHvBX.js";
...
class m {
  ...
  addTransform(e, t, n, i) {
    ...
    let a = o - n.depth;
    return a > W && (l = Q(l, a), o -= a), new m(l.append(s), o);
  }
  remapping(e, t) {
    let n = new G();
...
function B(r, e, t, n) {
  ...
  if (t.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), p = r.prevTime == 0 || !o && r.prevComposition != l && (r.prevTime < (t.time || 0) - n.newGroupDelay || !J(t, r.prevRanges)), a = o ? C(r.prevRanges, t.mapping) : b(t.mapping.maps);
