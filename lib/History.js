...
import { T as S, a as z, Q as N, i as U, b as Z, g as $ } from "./RichTextEditor-C0nuBmeS.js";
...
class m {
  ...
  addTransform(e, t, n, r) {
    ...
    let a = l - n.depth;
    return a > W && (o = Q(o, a), l -= a), new m(o.append(s), l);
  }
  remapping(e, t) {
    let n = new G();
...
function B(i, e, t, n) {
  ...
  if (t.getMeta("addToHistory") !== !1 && !(l && l.getMeta("addToHistory") === !1)) {
    let o = t.getMeta("composition"), p = i.prevTime == 0 || !l && i.prevComposition != o && (i.prevTime < (t.time || 0) - n.newGroupDelay || !J(t, i.prevRanges)), a = l ? C(i.prevRanges, t.mapping) : b(t.mapping.maps);
