...
import { a as P } from "./dom-dataset-CHDbKz5J.js";
import { S as B } from "./index-oQutU45z.js";
...
import { d as q, k as K, N as U, O as G } from "./RichTextEditor-C0nuBmeS.js";
import { u as F, k as h } from "./index-5T4epA8j.js";
function j(i, d) {
  var R, L;
  ...
  function f({ event: l }) {
    return l.key === "ArrowUp" ? (w(), !0) : l.key === "ArrowDown" ? (b(), !0) : l.key === "Enter" ? (k(), !0) : !1;
  }
  function w() {
    var m;
    if (i.items.length === 0)
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      ref: r,
      children: (R = i == null ? void 0 : i.items) != null && R.length ? /* @__PURE__ */ g("div", { className: "richtext-grid richtext-min-w-48 richtext-grid-cols-1 richtext-gap-0.5", children: (L = i == null ? void 0 : i.items) == null ? void 0 : L.map((l, c) => /* @__PURE__ */ N(T, { children: [
      ...
      B({
        ...
        items: ({ query: i, editor: d }) => W(d.extensionManager.extensions, this.options.renderGroupItem).map((r) => ({
          ...
          commands: r.commands.filter((s) => {
            ...
            if (s.aliases) {
              const w = s.aliases.map((C) => C.toLowerCase().trim()), b = u.match(f), k = w.some((C) => C.match(f));
              return b || k;
            }
            return u.match(f);
          }).filter(
