...
import { V as P, W as R, X as I, Y as Z, Z as W, _ as O, $ as C, A as N } from "./RichTextEditor-C0nuBmeS.js";
...
import { u as te } from "./index-5T4epA8j.js";
const re = {
...
function oe({ editor: t, node: n, updateAttributes: i, deleteNode: c, extension: a }) {
  var L;
  const o = K(null), r = Z(), { hasTrigger: l, fileName: m, fileSize: f, fileExt: E, fileType: b, url: d, error: T } = n.attrs, [V, g] = Q(!1), { t: w } = te(), F = (L = a == null ? void 0 : a.options) == null ? void 0 : L.upload, u = k(() => {
