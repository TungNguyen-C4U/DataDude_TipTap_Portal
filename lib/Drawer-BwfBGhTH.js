...
import { d, v as re, w as oe, A as le, x as ne, y as ie, z as se, B as ae, F as ce, G as Z, J as he, K as ue } from "./RichTextEditor-D4neHvBX.js";
...
import { I as K, j as fe, k as J } from "./index-p_4uATkU.js";
...
function tt({ editor: t, node: r, updateAttributes: o, getPos: i, selected: m }) {
  const [p, b] = M({
    ...
    const { src: h, alt: E, width: L, height: z } = r == null ? void 0 : r.attrs, _ = j(L) ? `${L}px` : L, w = j(z) ? `${z}px` : z;
    return {
      src: h || void 0,
      alt: E || void 0,
      style: {
  ...
  function a(h, E) {
    ...
    const L = A.width, z = A.height, _ = L / z;
  ...
  const u = P(
    Z((h) => {
      if (h.preventDefault(), h.stopPropagation(), !x)
        return;
      const { x: E, w: L, dir: z } = s, _ = (h.clientX - E) * (/l/.test(z) ? -1 : 1), { width: w, height: N } = r == null ? void 0 : r.attrs, H = w / N, U = he(L + _, fe, p.width), ee = Math.round(U / H);
      o({
        width: U,
        height: ee
      });
      ...
      children: /* @__PURE__ */ y(
        "div",
        {
          ...
          children: [
            ...
            t.view.editable && (m || x) && /* @__PURE__ */ e("div", { className: "image-resizer", children: k == null ? void 0 : k.map((h) => /* @__PURE__ */ e(
              "span",
              {
